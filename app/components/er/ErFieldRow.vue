<template>
  <div class="er-field-row" :class="{
    'er-field-row--primary': field.isPrimary,
    'er-field-row--relation': field.type === 'relation',
    'er-field-row--hover': isHovered
  }" @mouseenter="isHovered = true" @mouseleave="isHovered = false" @dblclick.stop="$emit('edit', field, index)">
    ...
    <div v-if="field.type === 'relation'" class="er-field-anchor" :data-source-id="entityId"
